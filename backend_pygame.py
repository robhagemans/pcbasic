...
if pygame:
    ...
    composite_1 =   {
        ...
        'cga': [
            (0x00, 0x00, 0x00),        (0x00, 0xb5, 0xff),        (0x00, 0x73, 0xff),        (0x00, 0xce, 0xff),
            (0xff, 0x00, 0x00),        (0x23, 0xd9, 0xb9),        (0xba, 0x8f, 0xa5),        (0x00, 0xf8, 0xff),
            (0xff, 0x00, 0x00),        (0x71, 0xc6, 0xff),        (0xdd, 0x7d, 0xef),        (0x35, 0xdf, 0xff),
            (0xff, 0x04, 0x00),        (0xff, 0xdf, 0x9c),        (0xff, 0x94, 0x89),        (0xff, 0xff, 0xff)    ],
        'tandy': [
            (0x00, 0x00, 0x00),        (0x00, 0xaf, 0x00),        (0x47, 0x68, 0x00),        (0x1e, 0xdb, 0x00),
            (0x00, 0x3e, 0xff),        (0x23, 0xd9, 0xb9),        (0x8e, 0x9a, 0xff),        (0xa1, 0xf9, 0x3b),
            (0x64, 0x33, 0xff),        (0xa5, 0xbc, 0x9f),        (0xdd, 0x7d, 0xef),        (0xf6, 0xe4, 0x0e),
            (0x7b, 0x38, 0xff),        (0xad, 0xd4, 0xff),        (0xee, 0x91, 0xff),        (0xff, 0xff, 0xff)    ],
        'pcjr': [
            (0x00, 0x00, 0x00),        (0x00, 0xe3, 0x58),        (0x00, 0x8b, 0x60),        (0x00, 0xfc, 0x6d),
            (0xff, 0x00, 0x39),        (0x23, 0xd9, 0xb9),        (0xb8, 0x82, 0xbc),        (0x00, 0xff, 0xce),
            (0xff, 0x00, 0x71),        (0x70, 0xd3, 0xec),        (0xdd, 0x7d, 0xef),        (0xf6, 0xff, 0xff),
            (0xff, 0x00, 0x71),        (0xff, 0xd2, 0xea),        (0xff, 0x7c, 0xee),        (0xff, 0xff, 0xff)    ],
       } 

    composite_0 =   {
        'cga_old': [
            (0x00, 0x00, 0x00),        (0x00, 0x75, 0x6c),        (0x00, 0x31, 0x6f),        (0x00, 0x53, 0x41),
            (0x7a, 0x33, 0x00),        (0x39, 0xbe, 0x42),        (0x82, 0x74, 0x48),        (0x53, 0x9b, 0x0e),
            (0xeb, 0x33, 0x08),        (0xd2, 0xc4, 0x99),        (0xf8, 0x7a, 0x9b),        (0xd9, 0xa0, 0x6b),
            (0xb3, 0x44, 0x00),        (0x8b, 0xd0, 0x4a),        (0xbf, 0x87, 0x51),        (0x98, 0xad, 0x14)    ],
        'cga': [
            (0x00, 0x00, 0x00),        (0x00, 0x9e, 0xe3),        (0x00, 0x5a, 0xd0),        (0x00, 0xa5, 0xf6),
            (0xff, 0x07, 0x00),        (0x45, 0xc8, 0x4c),        (0xc0, 0x7c, 0x38),        (0x37, 0xcd, 0x60),
            (0xff, 0x00, 0x00),        (0x84, 0xb2, 0x9c),        (0xe3, 0x66, 0x87),        (0x7b, 0xb8, 0xae),
            (0xff, 0x0d, 0x00),        (0xc6, 0xce, 0x2b),        (0xff, 0x81, 0x0d),        (0xc0, 0xd4, 0x43)    ],
        'tandy': [
            (0x00, 0x00, 0x00),        (0x00, 0xaa, 0x00),        (0x57, 0x63, 0x00),        (0x19, 0xbf, 0x00),
            (0x00, 0x3a, 0xff),        (0x45, 0xc8, 0x4c),        (0x9b, 0x85, 0xa1),        (0x88, 0xdc, 0x00),
            (0x54, 0x34, 0xff),        (0xad, 0xa2, 0x2e),        (0xe3, 0x66, 0x87),        (0xdf, 0xbe, 0x00),
            (0x39, 0x35, 0xff),        (0x88, 0xc0, 0x89),        (0xc6, 0x81, 0xd9),        (0xc0, 0xd4, 0x43)    ],
        'pcjr': [
            (0x00, 0x00, 0x00),        (0x00, 0xcc, 0x15),        (0x00, 0x73, 0x27),        (0x00, 0xda, 0x00),
            (0xff, 0x00, 0x00),        (0x45, 0xc8, 0x4c),        (0xbe, 0x6d, 0x52),        (0x1e, 0xd5, 0x3d),
            (0xff, 0x00, 0x3d),        (0x82, 0xc0, 0x83),        (0xe3, 0x66, 0x87),        (0x6f, 0xce, 0x76),
            (0xff, 0x00, 0x04),        (0xce, 0xc6, 0x52),        (0xff, 0x69, 0x57),        (0xc0, 0xd4, 0x43)    ],
       } 
