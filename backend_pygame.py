...
if android:
    ...
    keycode_to_unicode = {
        ...
        pygame.K_COLON       : u':',  
        # mapped to back key; but 'ESC' on Hacker's keyboard sends something else
...
def get_pen(fn):
    ...
    if fn == 0:
        ...
        return min(console.height, max(1, 1 + posy//font_height))
    elif fn == 9:
        return min(console.width, max(1, 1 + posx//xscale))
