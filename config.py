...
#    'program':  { 'metavar':'basic_program', 'nargs':'?', 'help':'Input program file to run (default), load or convert.' },
    ...
    'strict_hidden_lines':{ 'action':'store_true', 'help':'Disable listing and ASCII saving of lines beyond 65530 (as in GW-BASIC). Use with care as this allows execution of unseen statements.' },
    'strict_protect':   { 'action':'store_true', 'help':'Disable listing and ASCII saving of protected files (as in GW-BASIC). Use with care as this allows execution of unseen statements.' },
