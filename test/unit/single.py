...
class TestSingle(unittest.TestCase):
    ...
    def test_all_bytes_add(self):
        ...
        with open(os.path.join(HERE, 'input', 'ALLWORD.DAT'), 'rb') as f:
            with open(os.path.join(HERE, 'model', 'GWBASABY.DAT'), 'rb') as h:
                with open(os.path.join(HERE, 'output', 'ADDBYTE.DAT'), 'wb') as g:
                    while True:
    ...
    def test_all_bytes_sub(self):
        ...
        with open(os.path.join(HERE, 'input', 'ALLWORD.DAT'), 'rb') as f:
            with open (os.path.join(HERE, 'model', 'GWBASSBY.DAT'), 'rb') as h:
                with open(os.path.join(HERE, 'output', 'SUBBYTE.DAT'), 'wb') as g:
                    while True:
                        buf = bytearray(f.read(4))
                        if len(buf) < 4:
                            break
    ...
    def _cmp_add_exponents(self, shift, finput, model, output):
        ...
        with open(os.path.join(HERE, 'input', finput), 'rb') as f:
            with open (os.path.join(HERE, 'model', model), 'rb') as h:
                with open(os.path.join(HERE, 'output', output), 'wb') as g:
                    while True:
                        l = r
    ...
    def test_mult(self):
        ...
        r = self._vm.new_single()
        with open(os.path.join(HERE, 'input', 'BIGBYTES.DAT'), 'rb') as f:
            with open (os.path.join(HERE, 'model', 'GWBIGMUL.DAT'), 'rb') as h:
                with open(os.path.join(HERE, 'output', 'BIGMUL.DAT'), 'wb') as g:
                    while True:
                        l = r
                        buf = bytearray(f.read(4))
                        if len(buf) < 4:
