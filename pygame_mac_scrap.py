""" pygame_mac_scrap.py 
    ...
    This file is a copy of mac_scrap.py from PyGame.
    It's included here as a workaround for problems with the scrap module 
    when imported the regular way on OSX.
